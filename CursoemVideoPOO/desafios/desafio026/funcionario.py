...
class Funcionario(ABC):
    ...
    def analisar_salario(self):
        ...
        mensagem = f"O salario de [cyan]{self.nome}[/] ([magenta]{self.__class__.__name__}[/]) é de [green]R${self.salario:.2f}[/] e corresponde a [red]{base:.1f} salarios minimos.[/]"
        painel = Panel(mensagem,title= "Analise de Salarios", width=50)
        print(painel)
